            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    padding: const EdgeInsets.fromLTRB(12, 24, 12, 0),
                    child: const Text(
                        'In HTML, comments are written using <!-- Comment --> for single line or multiline comment, most of the time comments are used for writing explanations for codes as other developers are going to read them.',
                        style: TextStyle(
                          fontSize: 16,
                        ))),
